...
$CROSS_COMPILER_PATH/mips-ld -T $MIPS_C_TEST_CASES_PATH/linker.ld outlier.o -o outlier.bin

$CROSS_COMPILER_PATH/mips-objcopy -O binary outlier.bin x/outlier_${1}_${2}.x
