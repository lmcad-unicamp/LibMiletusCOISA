...
1)  ./compile.sh $CLASS_PATH
    ...
    java -Dfile.encoding=UTF-8 -DFIX_IO_CONTENT="true" -DRANGE="[10..30]" -DQUERY_TYPE="0" -classpath .:$CLASS_PATH MinMax < $INPUT_PATH/t01.in > $OUTPUT_PATH/t01.out
    echo -e "\n=========================== Test 01 diff ===========================\n"
    diff $GOLD_PATH/t01.gold $OUTPUT_PATH/t01.out
    ;;
2)  ./compile.sh $CLASS_PATH
    rm -f $OUTPUT_PATH/t02.out
    java -Dfile.encoding=UTF-8 -DFIX_IO_CONTENT="true" -DRANGE="[1000..3000]" -DQUERY_TYPE="0" -classpath .:$CLASS_PATH MinMax < $INPUT_PATH/t02.in > $OUTPUT_PATH/t02.out
    echo -e "\n=========================== Test 02 diff ===========================\n"
    diff $GOLD_PATH/t02.gold $OUTPUT_PATH/t02.out
    ;;
3)  ./compile.sh $CLASS_PATH
    rm -f $OUTPUT_PATH/t03.out
    java -Dfile.encoding=UTF-8 -DFIX_IO_CONTENT="true" -DRANGE="[1.5f..5.5f]" -DQUERY_TYPE="0" -classpath .:$CLASS_PATH MinMax < $INPUT_PATH/t03.in > $OUTPUT_PATH/t03.out
    echo -e "\n=========================== Test 03 diff ===========================\n"
    diff $GOLD_PATH/t03.gold $OUTPUT_PATH/t03.out
    ;;
4) ./compile.sh $CLASS_PATH
    rm -f $OUTPUT_PATH/t04.out
    java -Dfile.encoding=UTF-8 -DFIX_IO_CONTENT="true" -DRANGE="[10.2f..14.2f]" -DQUERY_TYPE="0" -classpath .:$CLASS_PATH MinMax < $INPUT_PATH/t04.in > $OUTPUT_PATH/t04.out
    echo -e "\n=========================== Test 04 diff ===========================\n"
    diff $GOLD_PATH/t04.gold $OUTPUT_PATH/t04.out
    ;;
5) ./compile.sh $CLASS_PATH
    rm -f $OUTPUT_PATH/t05.out
    java -Dfile.encoding=UTF-8 -DFIX_IO_CONTENT="true" -DRANGE="[300..400]" -DQUERY_TYPE="0" -classpath .:$CLASS_PATH MinMax < $INPUT_PATH/t05.in > $OUTPUT_PATH/t05.out
    echo -e "\n=========================== Test 05 diff ===========================\n"
    diff $GOLD_PATH/t05.gold $OUTPUT_PATH/t05.out
    ;;
6) ./compile.sh $CLASS_PATH
    rm -f $OUTPUT_PATH/t06.out
    java -Dfile.encoding=UTF-8 -DFIX_IO_CONTENT="true" -DRANGE="[1.0f..2.0f]" -DQUERY_TYPE="0" -classpath .:$CLASS_PATH MinMax < $INPUT_PATH/t06.in > $OUTPUT_PATH/t06.out
    echo -e "\n=========================== Test 06 diff ===========================\n"
    diff $GOLD_PATH/t06.gold $OUTPUT_PATH/t06.out
    ;;
7) ./compile.sh $CLASS_PATH
    rm -f $OUTPUT_PATH/t07.out
    java -Dfile.encoding=UTF-8 -DFIX_IO_CONTENT="true" -DRANGE="[0.65f..0.7f]" -DQUERY_TYPE="0" -classpath .:$CLASS_PATH MinMax < $INPUT_PATH/t07.in > $OUTPUT_PATH/t07.out
    echo -e "\n=========================== Test 07 diff ===========================\n"
    diff $GOLD_PATH/t07.gold $OUTPUT_PATH/t07.out
    ;;
8) ./compile.sh $CLASS_PATH
    rm -f $OUTPUT_PATH/t08.out
    java -Dfile.encoding=UTF-8 -DFIX_IO_CONTENT="true" -DRANGE="[20..30.7f]" -DQUERY_TYPE="0" -classpath .:$CLASS_PATH MinMax < $INPUT_PATH/t08.in > $OUTPUT_PATH/t08.out
    echo -e "\n=========================== Test 08 diff ===========================\n"
    diff $GOLD_PATH/t08.gold $OUTPUT_PATH/t08.out
    ;;
9) ./compile.sh $CLASS_PATH
    rm -f $OUTPUT_PATH/t09.out
    java -Dfile.encoding=UTF-8 -DFIX_IO_CONTENT="true" -DRANGE="[0.0f..10.0f]" -DQUERY_TYPE="1" -classpath .:$CLASS_PATH MinMax < $INPUT_PATH/t09.in > $OUTPUT_PATH/t09.out
    echo -e "\n=========================== Test 09 diff ===========================\n"
    diff $GOLD_PATH/t09.gold $OUTPUT_PATH/t09.out
    ;;
10) ./compile.sh $CLASS_PATH
    rm -f $OUTPUT_PATH/t10.out
    java -Dfile.encoding=UTF-8 -DFIX_IO_CONTENT="true" -DRANGE="[5..15]" -DQUERY_TYPE="1" -classpath .:$CLASS_PATH MinMax < $INPUT_PATH/t10.in > $OUTPUT_PATH/t10.out
    echo -e "\n=========================== Test 10 diff ===========================\n"
