...
void print_float(uint32_t float_address, uint32_t precision)
{
  ...
  num.as_int32 = ((uint32_t)(VM_memory[float_address + 0]) << 24) | ((uint32_t)(VM_memory[float_address + 1]) << 16) |
                 ((uint32_t)(VM_memory[float_address + 2]) << 8) | ((uint32_t)(VM_memory[float_address + 3]) << 0);
...
void print_double(uint32_t double_address, uint32_t precision)
{
  ...
  num.as_int64 = ((uint64_t)(VM_memory[double_address + 0]) << 56) | ((uint64_t)(VM_memory[double_address + 1]) << 48) |
                 ((uint64_t)(VM_memory[double_address + 2]) << 40) | ((uint64_t)(VM_memory[double_address + 3]) << 32) |
                 ((uint64_t)(VM_memory[double_address + 4]) << 24) | ((uint64_t)(VM_memory[double_address + 5]) << 16) |
                 ((uint64_t)(VM_memory[double_address + 6]) << 8) | ((uint64_t)(VM_memory[double_address + 7]) << 0);
