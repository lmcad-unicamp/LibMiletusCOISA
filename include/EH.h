...
// CREATION
extern volatile unsigned int robot_proximit_threshold;
extern volatile unsigned int robot_timer_threshold;
extern volatile unsigned int room_temperature_above_threshold;
extern volatile unsigned int room_temperature_below_threshold;
extern volatile unsigned int room_presence_threshold; // 0 = none 1 = on; 2 = off; 3 = both
extern volatile int car_hour_threshold1;
extern volatile int car_hour_threshold2;
...
The last one, the pointer vector, holds the number of handlers and the position of the handler in the first vector for
all the registered events. One event may have more than one handler, that`s why there are more than one structure to
hold the handler`s info.
*/
